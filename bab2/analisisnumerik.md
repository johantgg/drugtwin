2.1.7	Analisis Numerik dengan FEM  (Plaxis 2D versi 8.6)
2.1.7.1 Finite Element Method dan Plaxis 2D
...
2.1.7.2 Pemodelan Tanah Lunak “Mohr-Coulomb vs Soft Soil Model”
...
2.1.7.3 Pemodelan CDM sebagai Rigid Inclusion dalam 2D
...
2.1.7.4 Pemodelan CPM sebagai Timbunan Ringan
...
2.1.7.5 Tahapan Konstruksi (Staged Construction)
...
2.1.7.6 Output Analisis Numerik
